 ...
 */
function lv1080_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Lv1080 default saturation level.
	 *
	 * @since Lv1080 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'lv1080_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.lv1080-front-page) .entry-title,
...
.colors-custom .lv1080-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.lv1080-front-page .panel-content .recent-posts article,
...
.colors-custom.lv1080-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Lv1080 custom colors CSS.
	 *
	 * @since Lv1080 1.0
	 *
	 ...
	 */
	return apply_filters( 'lv1080_custom_colors_css', $css, $hue, $saturation );
}
